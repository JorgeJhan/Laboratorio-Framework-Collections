...
//verifica si existe otro elemento con el método hasNext()
        ...
        // ORGANIZAMOS LA LISTA E IMPRIMIMOS
        //-----------------------------------------------------------------------------------------------------------------------------------------
        Collections.sort(lista);//UTILIZAMOS EL FRAMEWORK COLLECTIONS
        System.out.println(" \nLISTA ORGANIZADA POR NOMBRE DE PRODUCTO " + lista.size() + " PRODUCTOS " + lista);
...
// Definir Iterator para extraer e imprimir valores 
        ...
        // imprimir en orden con Collections.sort();
